...
public class GremlinMatchGamePatch {
  private static final EventStrings eventStrings =
      CardCrawlGame.languagePack.getEventString("Match and Keep!");
  ...
  public static class ConstructorPatch {
    ...
    public static void Postfix(GremlinMatchGame __instance) {
      CardGroup cards =
          (CardGroup) ReflectionHacks.getPrivate(__instance, GremlinMatchGame.class, "cards");
      for (int p = 0; p < 12; p++) {
  ...
  public static class UpdateGameMatchLogicPatch {
    ...
    public static void Postfix(GremlinMatchGame __instance) {
      int attemptCount =
          (int) ReflectionHacks.getPrivate(__instance, GremlinMatchGame.class, "attemptCount");
      ...
      AbstractCard hoveredCard =
          (AbstractCard)
              ReflectionHacks.getPrivate(__instance, GremlinMatchGame.class, "hoveredCard");
