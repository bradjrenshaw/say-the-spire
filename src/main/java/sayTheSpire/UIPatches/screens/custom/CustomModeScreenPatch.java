...
public class CustomModeScreenPatch {
  ...
  private static final UIStrings uiStrings =
      CardCrawlGame.languagePack.getUIString("CustomModeScreen");
  ...
  public static String getAscensionLevelString(int level) {
    if (level <= 0) return CharacterSelectScreen.A_TEXT[0];
  ...
  public static class updateAscensionPatch {
    ...
    public static void Postfix(CustomModeScreen __instance) {
      Hitbox ascensionModeHb =
          (Hitbox)
              ReflectionHacks.getPrivate(__instance, CustomModeScreen.class, "ascensionModeHb");
  ...
  public static class UpdateSeedPatch {
    ...
    public static void Postfix(CustomModeScreen __instance) {
      Hitbox seedHb =
          (Hitbox) ReflectionHacks.getPrivate(__instance, CustomModeScreen.class, "seedHb");
      if (seedHb.justHovered) {
        String currentSeed =
            (String) ReflectionHacks.getPrivate(__instance, CustomModeScreen.class, "currentSeed");
