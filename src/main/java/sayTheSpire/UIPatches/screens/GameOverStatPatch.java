...
public class GameOverStatPatch {
  ...
  @SpirePatch(
      ...
      paramtypez = {String.class, String.class, String.class})
  public static class ConstructorPatch {

    public static void Postfix(
        GameOverStat __instance, String label, String description, String value) {
      hiddenStats.add(__instance);
    }
  }
  /*
      @SpirePatch(clz=GameOverStat.class, method=SpirePatch.CONSTRUCTOR, paramtypez={})
      public static class EmptyConstructorPatch {
  ...
  public static class UpdatePatch {
    ...
    public static void Postfix(GameOverStat __instance) {
      if (hiddenStats.contains(__instance) && !__instance.hidden) {
        ...
        else Output.setupUIBufferMany(__instance.label, __instance.value);
      }
    }
  }
}
