...
public class ApplyPowerActionPatch {
  ...
  public static void Insert(ApplyPowerAction __instance) {
    AbstractGameEffect effect =
        AbstractDungeon.effectList.get(AbstractDungeon.effectList.size() - 1);
  ...
  private static class Locator extends SpireInsertLocator {
    ...
    public int[] Locate(CtBehavior ctMethodToPatch)
      ...
      int buffArray[] =
          LineFinder.findAllInOrder(ctMethodToPatch, new ArrayList<Matcher>(), buffMatcher);
      int debuffArray[] =
          LineFinder.findAllInOrder(ctMethodToPatch, new ArrayList<Matcher>(), debuffMatcher);
