...
/**
 * A utility class that provides a builder object to more easily create input mapping default configs.
 */
public class MappingBuilder {
    ...
    public MappingBuilder mapping(Integer... keys) {
        ...
        InputMapping mapping = new InputMapping(this.currentActionName, this.defaultInputType, this.isDefault, mappingCodes);
